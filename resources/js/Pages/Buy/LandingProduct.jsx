                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        ...
                        <div className="relative overflow-hidden rounded-2xl">
                            <div className="flex gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide scroll-smooth">
                                {[
                                    {
                                        title: "Pantalla AMOLED HD",
                                        desc: "Colores vibrantes y máxima nitidez incluso bajo el sol.",
                                        img: "https://cdnx.jumpseller.com/race-ready-nutrition/image/61132825/thumb/1079/1079?1741557682",
                                    },
                                    {
                                        title: "Resistente al agua",
                                        desc: "Úsalo sin preocupaciones bajo la lluvia o al nadar.",
                                        img: "https://cdnx.jumpseller.com/race-ready-nutrition/image/61132825/thumb/1079/1079?1741557682",
                                    },
                                    {
                                        title: "Batería de larga duración",
                                        desc: "Hasta 7 días de uso continuo con una sola carga.",
                                        img: "https://cdnx.jumpseller.com/race-ready-nutrition/image/61132825/thumb/1079/1079?1741557682",
                                    },
                                ].map((item, i) => (
                                    <div
                    ...
                    <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 text-gray-600">
                                ...
                                <li>✔ Controla tu salud en tiempo real</li>
